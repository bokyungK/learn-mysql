          ...
          db.query('SELECT * FROM author', (error, authors) => {
            ...
            const html = template.HTML(sanitizeHtml(title), list,
              ...
              <form action="/update_process" method="post">
                ...
                <p><input type="text" name="title" placeholder="update title!" value="${sanitizeHtml(topic[0].title)}"></p>
                <p>
                  <textarea name="description" placeholder="update description!">${sanitizeHtml(topic[0].description)}</textarea>
                </p>
                <p>
